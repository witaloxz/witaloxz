...
<p align="center">
  ...
  <blockquote>
    <p>
      My name is <strong>Witalo Dias</strong> and I'm a <strong>Full-Stack Developer</strong> focused on building complete, scalable, and well-structured web applications.<br/>
      I work with <strong>front-end</strong> and <strong>back-end</strong>, developing <strong>REST APIs</strong>, integrating <strong>databases</strong>, and implementing authentication and authorization following best practices.<br/>
      My main stack is <strong>Angular</strong> and <strong>Spring Boot</strong>, always prioritizing clean, testable, and maintainable code.
      <img src="https://slackmojis.com/emojis/136978-60f/download" alt="party gif" width="30">
    </p>
  </blockquote>
</div>
<img width="100%" src="https://user-images.githubusercontent.com/74038190/212284115-f47cd8ff-2ffb-4b04-b5bf-4d1c14c0247f.gif" />

- Full-Stack Developer focused on building scalable and well-structured web applications, with strong attention to clean architecture and code quality.
- Experience in Front-end development using Angular with JavaScript and TypeScript.
- Experience in Back-end development using Java and Spring Boot, creating RESTful APIs and secure authentication.
